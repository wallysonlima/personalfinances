 ...
 * @author wally
 */
public class IUExcluirCartao extends javax.swing.JDialog {

    IUPrincipal principal = new IUPrincipal();
    Usuario usuario = principal.getUsuarioCorrente();
    
    public IUExcluirCartao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        comboBoxCartao.removeAllItems();
        
        for( Cartao cart: cartao )
            comboBoxCartao.addItem(cart);
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SELECIONAR CARTÃO");
    ...
    private void buttonLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLimparActionPerformed
        Cartao cartao = (Cartao) comboBoxCartao.getSelectedItem();
        
        if( cartao != null ) {
            principal.controlador.deletarCartao(usuario, cartao);
        
            principal.controlador.armazenarUsuarios();
            
            JOptionPane.showMessageDialog(null, "Cartão excluido com sucesso !", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUExcluirCartao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUExcluirCartao dialog = new IUExcluirCartao(new javax.swing.JFrame(), true);
